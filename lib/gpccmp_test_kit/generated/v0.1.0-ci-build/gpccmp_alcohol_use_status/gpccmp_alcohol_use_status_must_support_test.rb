...
module GPCCMPTestKit
  module GPCCMPV010_CI_BUILD
    class GpccmpAlcoholUseStatusMustSupportTest < Inferno::Test
      ...
      description %(
        ...
        * Observation.code
        * Observation.code.coding:snomedAlcoholUseStatusCode
      ...
      id :gpccmp_v010_ci_build_gpccmp_alcohol_use_status_must_support_test
