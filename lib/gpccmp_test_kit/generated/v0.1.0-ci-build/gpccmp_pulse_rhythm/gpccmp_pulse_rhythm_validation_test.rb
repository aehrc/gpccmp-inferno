...
module GPCCMPTestKit
  module GPCCMPV010_CI_BUILD
    class GpccmpPulseRhythmValidationTest < Inferno::Test
      include InfernoSuiteGenerator::ValidationTest

      id :gpccmp_v010_ci_build_gpccmp_pulse_rhythm_validation_test
      title 'Observation resources returned during previous tests conform to the GP CCMP Pulse Rhythm'
      description %(
This test verifies resources returned from the first search conform to
the [GP CCMP Pulse Rhythm](https://gpccmp.csiro.au/ig/StructureDefinition/GPCCMPPulseRhythm).
