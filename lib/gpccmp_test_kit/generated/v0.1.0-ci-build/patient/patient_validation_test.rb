...
module GPCCMPTestKit
  module GPCCMPV010_CI_BUILD
    class PatientValidationTest < Inferno::Test
      ...
      id :gpccmp_v010_ci_build_patient_validation_test
      title 'Patient resources returned during previous tests conform to the GP CCMP Patient'
      description %(
This test verifies resources returned from the first search conform to
the [GP CCMP Patient](https://gpccmp.csiro.au/ig/StructureDefinition/GPCCMPPatient).
