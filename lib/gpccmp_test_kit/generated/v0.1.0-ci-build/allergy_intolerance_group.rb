...
module GPCCMPTestKit
  module GPCCMPV010_CI_BUILD
    class AllergyIntoleranceGroup < Inferno::TestGroup
      title 'GP CCMP AllergyIntolerance Tests'
      short_description 'Verify support for the server capabilities required by the GP CCMP AllergyIntolerance.'
      description %(
  # Background

The GPCCMP GP CCMP AllergyIntolerance sequence verifies that the system under test is
able to provide correct responses for AllergyIntolerance queries. These queries
must contain resources conforming to the GP CCMP AllergyIntolerance as
...
the [GP CCMP AllergyIntolerance](https://gpccmp.csiro.au/ig/StructureDefinition/GPCCMPAllergyIntolerance). Each element is checked against
...
read succeeds.
      ...
      id :gpccmp_v010_ci_build_allergy_intolerance
      run_as_group
      ...
      test from: :gpccmp_v010_ci_build_allergy_intolerance_patient_search_test
      test from: :gpccmp_v010_ci_build_allergy_intolerance_validation_test
      test from: :gpccmp_v010_ci_build_allergy_intolerance_must_support_test
      test from: :gpccmp_v010_ci_build_allergy_intolerance_reference_resolution_test
    end
  end
end
