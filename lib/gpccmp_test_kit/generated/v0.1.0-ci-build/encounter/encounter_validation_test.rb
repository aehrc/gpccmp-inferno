...
module GPCCMPTestKit
  module GPCCMPV010_CI_BUILD
    class EncounterValidationTest < Inferno::Test
      ...
      id :gpccmp_v010_ci_build_encounter_validation_test
      title 'Encounter resources returned during previous tests conform to the GP CCMP Encounter'
      description %(
This test verifies resources returned from the first search conform to
the [GP CCMP Encounter](https://gpccmp.csiro.au/ig/StructureDefinition/GPCCMPEncounter).
