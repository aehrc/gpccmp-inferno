...
module GPCCMPTestKit
  module GPCCMPV010_CI_BUILD
    class QuestionnaireResponsePatientQuestionnaireSearchTest < Inferno::Test
      ...
      title '(SHALL) Server returns valid results for QuestionnaireResponse search by patient + questionnaire'
      description %(
...
[GPCCMP Server CapabilityStatement](https://gpccmp.csiro.au/ig/CapabilityStatement/csiro.fhir.au.gpccmp)
      ...
      id :gpccmp_v010_ci_build_questionnaire_response_patient_questionnaire_search_test
      input :patient_ids,
            title: 'Patient IDs',
      ...
      def self.properties
        @properties ||= InfernoSuiteGenerator::SearchTestProperties.new(
          ...
          search_param_names: %w[patient questionnaire]
        )
      end
