...
module GPCCMPTestKit
  module GPCCMPV010_CI_BUILD
    class MedicationStatementValidationTest < Inferno::Test
      ...
      id :gpccmp_v010_ci_build_medication_statement_validation_test
      title 'MedicationStatement resources returned during previous tests conform to the GP CCMP MedicationStatement'
      description %(
This test verifies resources returned from the first search conform to
the [GP CCMP MedicationStatement](https://gpccmp.csiro.au/ig/StructureDefinition/GPCCMPMedicationStatement).
