...
module GPCCMPTestKit
  module GPCCMPV010_CI_BUILD
    class PractitionerRoleValidationTest < Inferno::Test
      ...
      id :gpccmp_v010_ci_build_practitioner_role_validation_test
      title 'PractitionerRole resources returned during previous tests conform to the GP CCMP PractitionerRole'
      description %(
This test verifies resources returned from the first search conform to
the [GP CCMP PractitionerRole](https://gpccmp.csiro.au/ig/StructureDefinition/GPCCMPPractitionerRole).
